...
export default function ProjectsSection() {
  ...
  const projects = [
    ...
    },
    {
      ...
      description: 'Engineered enterprise-grade cryptocurrency wallet with multi-asset support (crypto + NFTs) for business clients. Leveraged third-party APIs for seamless integration of data analytics tools, thereby enhancing project functionality and enabling real-time insights for informed decision-making.',
      tech: ['Node.js', 'Express.js', 'Redis', 'Sequelize'],
      date: 'June 2023',
    },
  ];

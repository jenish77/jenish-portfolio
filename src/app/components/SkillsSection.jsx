...
export default function SkillsSection() {
  ...
  const skillCategories = [
    ...
    },
    {
      ...
      skills: ['Node.js', 'NestJS', 'Express.js', 'GraphQL', 'Socket.IO'],
    },
    {
      title: 'Frontend',
      icon: (
    ...
    },
    {
      ...
      skills: ['Docker', 'Kubernetes', 'AWS', 'CI/CD (Jenkins/GitHub Actions)', 'PM2'],
    },
    {
      title: 'Others',
      icon: (
      ...
      skills: ['Git', 'Data Structures', 'REST APIs', 'WebSockets'],
    },
  ];
